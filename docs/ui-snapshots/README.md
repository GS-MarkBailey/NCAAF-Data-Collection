...
| Marker | Content |
|--------|---------|
| `ui-evolution` | Latest week overview screens only (executive summary) |
| `week-N-screens` | Overview screenshots immediately after each week's **Theme** line |
| `week-N-interactions` | Feature screenshots inline with interaction copy |

Edit interaction text and feature mappings in `scripts/ui-snapshot-doc-content.mjs`.
...
3. Add a `## Week 5` section to the Confluence doc (prose only), plus markers after **Theme** and in the interactions section:
   ```markdown
   <!-- AUTO-SNAPSHOTS:week-5-screens:START -->
   <!-- AUTO-SNAPSHOTS:week-5-screens:END -->
