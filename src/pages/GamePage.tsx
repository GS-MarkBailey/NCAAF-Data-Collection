  ...
  return (
    <div className="flex h-dvh flex-col bg-[var(--color-app-bg)] safe-t safe-b">
      ...
      <div className="flex min-h-0 flex-1 flex-col safe-l safe-r pb-0 landscape-mobile:pb-2">
        <div
          className={cn(
            'grid min-h-0 flex-1 grid-cols-1 gap-3 rounded-[var(--radius-panel)] border-[3px] p-3 transition-colors md:grid-cols-3 landscape-mobile:grid-cols-3 landscape-mobile:gap-3 landscape-mobile:p-3',
            takeControl
